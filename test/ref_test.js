var Agent = require('../api/controllers/agent');
...
var deployment_test = {
    'deployment_id': 1,
    'project_type': 'oshi',
    'deployment_type': 'oshi-mininet',
    'deployment_descriptor': {}
}

testAgent.createDeployment(deployment_test, function () {
    console.log( 'Deployment successful loaded.');
}, function (error) {
    console.log(error);
});